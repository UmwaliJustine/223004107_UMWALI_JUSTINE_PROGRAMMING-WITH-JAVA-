	...
	public static void main(String[] args) {
		...
		do{
			...
			case 3:
				...
				double sqre=sc.nextDouble();
				square Sqre=new square(sqre);
				System.out.println("What would you like to do ");
				System.out.println("1: Area");
				System.out.println("2: Perimeter");
				System.out.print("Choose: ");
				...
				int side = sc.nextInt();
				if(side == 1) {
					System.out.println("Area Of Rectangle: " + Sqre.calculateArea());
				}else if(side == 2) {
					System.out.println("Parameter Of Rectangle:" + Sqre.calculatePerimeter());
				}else {
					System.out.println("Choose 1 or 2 options");
				}
			...
			case 4:
				...
				triangle Tr=new triangle(base, hgh);
				System.out.println("What would you like to do ");
				System.out.println("1: Area");
				System.out.println("2: Perimeter");
				System.out.print("Choose: ");
